...
from src.home.wagtailCloudinary.abstract import AbstractRendition,AbstractCloudinaryImage,AbstractCloudinaryRendition
...
from src.home.panels import  ListSnippetPanel
...
class Nosotros(Page):
    ...
    mision = models.CharField(max_length=300 ,verbose_name= "Mision") 
    vision = models.CharField(max_length=350 ,verbose_name= "Vision") 
    ...
    content_panels = Page.content_panels + [
        ...
        MultiFieldPanel([FieldPanel('middleMensajeTitle'),FieldPanel('middleMensaje')],heading="Mensaje Intermedio"),
    ...
    api_fields = [
            ...
            APIField('puvName'),
            APIField('puvImage'),
            APIField('middleMensaje'),
            APIField('middleMensajeTitle'),
            APIField('vision'),
            APIField('mision'),
